...
typedef struct {
    ...
    bool     has_fmv_pack;
    const char* fmv_pack_label;
    const char* const* bookmark_labels;  // borrowed; NULL/num_bookmarks==0 => no "Start at" row
    int      num_bookmarks;
...
void launcher_model_cycle_bookmark(LauncherModel* m);           // Normal boot -> bookmark 1 -> ... -> wraps
